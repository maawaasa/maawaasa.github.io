-- =====================================================
-- ⚠️ مهمل — DEPRECATED — لا تشغّل هذا الملف على أي بيئة
-- ملف قديم لمخطط BIGINT سبق استبداله. تشغيله يعيد سياسات
-- anon-INSERT الملغاة أمنيًا. سلسلة التأسيس الحالية:
--   000_new_project.sql → 013_quotes_mvp.sql
-- =====================================================
-- =====================================================
